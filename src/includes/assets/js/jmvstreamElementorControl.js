function checkElementorPage() {
    const page = window.location.href;
    if (page.includes('action=elementor')) {
        return true;
    }
}

if (checkElementorPage()) {
    ...
    function openModal(textAreaId) {
        ...
        textAreaId = textAreaId.replace('elementor-control-default-c', '');
        textAreaId = textAreaId - 1;

        var newInputId = inputId;
        newInputId.id = textAreaId;
        ...
        <div id="jmvstream__wrap" class="wrap">
            ...
            <a href="https://hub.jmvtechnology.com/#/home" target="_blank" class="jmvstream__page-title-action">${jmvstream.translations.add_video}</a>
    
            <a href="${jmvstream.translations.plan_upgrade_url}" target="_blank" class="jmvstream__page-title-action">${jmvstream.translations.plan_upgrade}</a>
    
            <h2 class="screen-reader-text">${jmvstream.translations.filter_videos}</h2>
            
            <div class="jmvstream__wp-filter">
            <form method="post">
                <div class="jmvstream__filter-container">
                    <div class="jmvstream__filter-item">
                        <label for="jmvstream__initial-date" class="">${jmvstream.translations.initial_date}</label>
                        <input type="date" format="dd/mm/yyyy" id="jmvstream__initial-date" name="jmvstream__initial-date" value="" placeholder="dd/mm/yyyy" />
                    </div>
                    <div class="jmvstream__filter-item">
                        <label for="jmvstream__end-date" class="">${jmvstream.translations.end_date}</label>
            ...
            <table id="jmvstream__table" class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="jmvstream__col-header">
                            <a>
            ...
            <div id="jmvstream__paginator" class="tablenav bottom">
                <div class="jmvstream__tablenav-pages">
                    ...
                    <div class="jmvstream__pagination">
                        <span id="jmvstream__prev-page" class="tablenav-pages-navspan button disabled" aria-hidden="true">
                        ...
                        <span id="jmvstream__next-page" class="tablenav-pages-navspan button" aria-hidden="true">
        ...
        <div class="clear"></div>
        `;
        const closeModalButton = `<button type="button" class="jmvstream__close-modal-icon" onclick="closeModal()">
        ...
        $(function () {
            ...
            getHubVideos(title, page, gallery, orderBy, sort, initialDate, endDate, 'elementor');
    ...
    function addVideoToPage(slug) {
        ...
        var input = document.getElementById(`elementor-control-default-c${inputId.id}`);
        input.value = value;
